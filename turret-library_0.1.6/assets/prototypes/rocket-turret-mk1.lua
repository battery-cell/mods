...
itemEquipment.name = "rocket-turret-mk1-equipment"
itemEquipment.icon = "__turret-library__/assets/graphics/icons/rocket-turret-mk1-equipment.png"
itemEquipment.place_as_equipment_result = "rocket-turret-mk1-equipment"
itemEquipment.order = "b[battery]-u[solar-panel-equipment]"
data:extend
({
	itemEquipment
})
...
recipeEquipment.name = "rocket-turret-mk1-equipment"
recipeEquipment.enabled = false
recipeEquipment.results = {{type="item", name="rocket-turret-mk1-equipment", amount=1}}
...
equipment.name = "rocket-turret-mk1-equipment"
equipment.sprite.filename = "__turret-library__/assets/graphics/equipment/rocket-turret-mk1-equipment.png"
...
entity.name = "rocket-turret-mk1-b"
...
return
{
	filename = "__turret-library__/assets/graphics/rocket-turret-mk1/rocket-turret-mk1-attack.png",
	width = 256,
	height = 256,
	direction_count = 8,
...
return
{
	filename = "__turret-library__/assets/graphics/rocket-turret-mk1/rocket-turret-mk1-attack-mask.png",
	width = 256,
	height = 256,
	direction_count = 8,
	shift = util.by_pixel(0, -15),
...
-- Attack
entity.attack_parameters = data.raw["gun"]["rocket-launcher"]["attack_parameters"]
data:extend
({
	entity
})