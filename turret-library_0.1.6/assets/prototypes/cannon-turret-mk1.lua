...
itemEquipment.name = "cannon-turret-mk1-equipment"
itemEquipment.icon = "__turret-library__/assets/graphics/icons/cannon-turret-mk1-equipment.png"
itemEquipment.place_as_equipment_result = "cannon-turret-mk1-equipment"
itemEquipment.order = "b[battery]-s[solar-panel-equipment]"
data:extend
({
	itemEquipment
})
...
recipeEquipment.name = "cannon-turret-mk1-equipment"
recipeEquipment.enabled = false
recipeEquipment.results = {{type="item", name="cannon-turret-mk1-equipment", amount=1}}
...
equipment.name = "cannon-turret-mk1-equipment"
equipment.sprite.filename = "__turret-library__/assets/graphics/equipment/cannon-turret-mk1-equipment.png"
...
entity.name = "cannon-turret-mk1-b"
...
return
{
	filename = "__turret-library__/assets/graphics/cannon-turret-mk1/cannon-turret-mk1-attack.png",
	width = 256,
	height = 256,
	direction_count = 8,
...
return
{
	filename = "__turret-library__/assets/graphics/cannon-turret-mk1/cannon-turret-mk1-attack-mask.png",
	width = 256,
	height = 256,
	direction_count = 8,
	shift = util.by_pixel(0, -15),
...
-- Attack
entity.attack_parameters = data.raw["gun"]["tank-cannon"]["attack_parameters"]
data:extend
({
	entity
})