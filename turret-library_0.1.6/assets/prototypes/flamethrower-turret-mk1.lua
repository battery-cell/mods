...
itemEquipment.name = "flamethrower-turret-mk1-equipment"
itemEquipment.icon = "__turret-library__/assets/graphics/icons/flamethrower-turret-mk1-equipment.png"
itemEquipment.place_as_equipment_result = "flamethrower-turret-mk1-equipment"
itemEquipment.order = "b[battery]-w[solar-panel-equipment]"
data:extend
({
	itemEquipment
})
...
recipeEquipment.name = "flamethrower-turret-mk1-equipment"
recipeEquipment.enabled = false
recipeEquipment.results = {{type="item", name="flamethrower-turret-mk1-equipment", amount=1}}
...
equipment.name = "flamethrower-turret-mk1-equipment"
equipment.sprite.filename = "__turret-library__/assets/graphics/equipment/flamethrower-turret-mk1-equipment.png"
...
entity.name = "flamethrower-turret-mk1-b"
...
return
{
	filename = "__turret-library__/assets/graphics/flamethrower-turret-mk1/flamethrower-turret-mk1-attack.png",
	width = 256,
	height = 256,
	direction_count = 8,
...
return
{
	filename = "__turret-library__/assets/graphics/flamethrower-turret-mk1/flamethrower-turret-mk1-attack-mask.png",
	width = 256,
	height = 256,
	direction_count = 8,
	shift = util.by_pixel(0, -15),
...
-- Attack
entity.attack_parameters = data.raw["gun"]["tank-flamethrower"]["attack_parameters"]		
-- Write result
data:extend
({
	entity
