...
transitions.beach_transitions =
{
  ...
  (
      ...
      "__alien-biomes-graphics__/graphics/terrain/water-transitions/sr/beach.png",
      "__alien-biomes-graphics__/graphics/terrain/water-transitions/beach.png",
      {
        o_transition_tall = false,
...
transitions.beach_transitions_between_transitions =
{
  ...
  (
      ...
      "__alien-biomes-graphics__/graphics/terrain/water-transitions/sr/beach-transition.png",
      "__alien-biomes-graphics__/graphics/terrain/water-transitions/beach-transition.png",
      {
        side_tall = false,
        inner_corner_tall = false,
        outer_corner_tall = false,
...
transitions.cliff_transitions =
{
  ...
  (
      water_tile_type_names,
      "__alien-biomes-graphics__/graphics/terrain/water-transitions/sr/cliff.png",
      "__alien-biomes-graphics__/graphics/terrain/water-transitions/cliff.png",
      {
        o_transition_tall = false,
...
transitions.cliff_transitions_between_transitions =
{
  ...
  (
      default_transition_group_id,
      water_transition_group_id,
      "__alien-biomes-graphics__/graphics/terrain/water-transitions/sr/cliff-transition.png",
      "__alien-biomes-graphics__/graphics/terrain/water-transitions/cliff-transition.png",
      {
        o_transition_tall = false,
        inner_corner_count = 3,
        outer_corner_count = 3,
